...
function displayPics(){
  ...
  // the variable "rando" is declared inside a function, using "let" scopes the variable to the function. makeRandom is still makeRandom everywhere else. By moving the console.log into the function it was able to use the locally scoped variable "rando"
  console.log(viewed);
